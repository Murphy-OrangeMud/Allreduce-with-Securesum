...
class AsyncAllreduceWork : public ProcessGroupGloo::AsyncWork {
 public:
  ...
  void allreduce(std::vector<at::Tensor>& tensors) {  //
    ...
    switch(scalarType) {
      case ::at::ScalarType::Float: {
        gloo::allreduce<float>(opts);
        break;
      }
      case ::at::ScalarType::Double: {
        gloo::allreduce<double>(opts);
        break;
      }
      case ::at::ScalarType::Half: {
        gloo::allreduce<gloo::float16>(opts);
        break;
      }
      case ::at::ScalarType::Char: {
        gloo::allreduce<int8_t>(opts);
        break;
      }
      case ::at::ScalarType::Byte: {
        gloo::allreduce<uint8_t>(opts);
        break;
      }
      case ::at::ScalarType::Int: {
        gloo::allreduce<int32_t>(opts);
        break;
      }
      case ::at::ScalarType::Long: {
        gloo::allreduce<int64_t>(opts);
        break;
      }
      default:
        TORCH_CHECK(false, "Invalid scalar type");
